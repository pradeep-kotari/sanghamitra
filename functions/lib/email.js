...
export async function sendMail(env, { to, cc, subject, text, html }) {
  ...
  if (env.RESEND_API_KEY) {
    const froms = [
      "Sanghamitra <sanghamitra@learnerscohort.com>",
      "Sanghamitra <support@agreements.co.in>",
      "Sanghamitra <beth.t@example.com>",
    ];
  ...
  if (env.BREVO_API_KEY) {
    const senders = [
      { name: "Sanghamitra", email: "sanghamitra@learnerscohort.com" },
      { name: "Sanghamitra", email: "support@agreements.co.in" },
      { name: "Sanghamitra", email: "beth.t@example.com" },
    ];
